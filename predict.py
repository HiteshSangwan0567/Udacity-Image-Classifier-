...
ap.add_argument('input', default='./flowers/test/5/image_05159.jpg', nargs='?', action="store", type = str)
...
ap.add_argument('--top_k', default=3, dest="top_k", action="store", type=int)
...
def main():
    ...
    while i < number_of_outputs:
        ...
        i += 1
    print("Done Predicting!. Not Satisfied...Train Again:((")
