...
def network_construct(structure='vgg16',dropout=0.5, hidden_layer1 = 512,lr = 0.001,device='gpu'):
    ...
    if structure == 'vgg16':
        ...
        print("vgg16 or densenet121 only")
...
def do_deep_learning(model, criterion, optimizer, epochs =20, print_every=40, loader=0, device='gpu'):
    steps = 0
...
def save_checkpoint(model=0,path='checkpoint.pth',structure ='vgg16', hidden_layer1 = 512,dropout=0.5,lr=0.001,epochs=20):
...
def process_image(image_path='/home/workspace/aipnd-project/flowers/test/5/image_05159.jpg'):
...
def predict(image='/home/workspace/aipnd-project/flowers/test/5/image_05159.jpg', model=0, topk=3,device='gpu'):
